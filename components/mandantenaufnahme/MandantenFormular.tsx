...
function MandantenFormularInner() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Modus vom Server holen — bei Graph-Verfügbarkeit gehen große
      // Uploads direkt an Microsoft (an unserer Function vorbei).
      ...
      if (graphUpload && files.length > 0) {
        ...
        // Legacy-Pfad — alles in einem Request, cap 4 MB.
