const de = {
  ...
  step1: {
    ...
    email: 'E-Mail',
    emailConfirm: 'E-Mail wiederholen',
    emailHint: 'Bitte prüfen Sie Ihre E-Mail sorgfältig — wir senden Ihnen die Vollmacht dorthin.',
    ...
    placeholderEmailConfirm: 'E-Mail erneut eingeben',
  },
  ...
  validation: {
    ...
    emailConfirmRequired: 'Bitte E-Mail zur Bestätigung erneut eingeben.',
...
const en: Translations = {
  ...
  step1: {
    ...
    emailHint: 'Please double-check your email — we will send the power of attorney there.',
    ...
    placeholderEmailConfirm: 'Re-enter your email',
  },
  ...
  validation: {
    ...
    emailConfirmRequired: 'Please re-enter your email to confirm.',
