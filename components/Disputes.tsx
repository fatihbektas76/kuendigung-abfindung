        ...
        <div className="grid grid-cols-2 gap-5 mt-10 max-md:grid-cols-1">
          {disputes.map((d) => (
            <FadeUp key={d.title} delay={d.delay}>
              <article className="bg-white border border-border-light rounded py-[30px] px-7 flex items-start gap-[18px] transition-all border-l-[3px] border-l-transparent hover:border-l-gold hover:translate-x-1">
