...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.german-litigation-lawyer.com/blog/${post.slug}`,
    },
    openGraph: {
      type: 'article',
      title: post.title,
      description: post.description,
      url: `https://www.german-litigation-lawyer.com/blog/${post.slug}`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'BlogPosting',
            '@id': `https://www.german-litigation-lawyer.com/blog/${post.slug}`,
            headline: post.title,
            description: post.description,
            ...
            image: {
              '@type': 'ImageObject',
              url: `https://www.german-litigation-lawyer.com/blog/${post.slug}.webp`,
            },
            author: {
              '@type': 'Person',
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.german-litigation-lawyer.com',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Insights',
                item: 'https://www.german-litigation-lawyer.com/blog',
              },
              {
                '@type': 'ListItem',
                position: 3,
                name: post.title,
                item: `https://www.german-litigation-lawyer.com/blog/${post.slug}`,
              },
            ],
          }),
        }}
