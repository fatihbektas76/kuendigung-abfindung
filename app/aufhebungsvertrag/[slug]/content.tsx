  ...
  return (
    <main className="pb-20">
          ...
          <div className="flex items-start gap-4 py-5 px-6 bg-cream rounded-sm border-l-[3px] border-gold">
            ...
            <div>
              <p className="text-[0.95rem] font-semibold text-ink m-0">
                Vorsicht: Sperrzeit-Risiko! Ein Aufhebungsvertrag kann zu 12 Wochen Sperrzeit
                beim Arbeitslosengeld führen (&sect;159 SGB III).
              </p>
          ...
          <div className="max-w-[600px]">
            <div className="border-[1.5px] border-gold rounded bg-cream p-8 text-center">
              ...
              <p className="text-[0.95rem] text-ink-light leading-relaxed mb-6">
                ...
                eine Ersteinschätzung zu Abfindung, Sperrzeit und versteckten Klauseln.
              </p>
              <a
                href="/#kontakt"
      ...
      <section className="py-[70px] px-8 bg-cream">
        <div className="max-w-content mx-auto">
          ...
          <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1">
            {[
              { step: 1, title: 'Vertrag einreichen', desc: 'Laden Sie Ihren Aufhebungsvertrag über das Kontaktformular hoch. Wir prüfen ihn kostenlos und geben Ihnen innerhalb von 24 Stunden eine Ersteinschätzung.' },
              { step: 2, title: 'Beratung erhalten', desc: 'In einem persönlichen Gespräch besprechen wir die Risiken und Ihre Optionen: Nachverhandlung, Ablehnung oder optimierte Annahme.' },
            ...
            {[
              {
                ...
                desc: 'Über 2.000 erfolgreiche Verfahren, 5,0 Sterne auf anwalt.de. Unsere Erfahrung ist Ihr Vorteil bei der Verhandlung.',
              ...
              },
              {
                ...
                desc: 'Vertrag hochladen, Ersteinschätzung in 24 Stunden erhalten. Alles digital, schnell und unkompliziert.',
            ...
            {aufhebungsvertragData.map((e) => (
              <Link
                ...
                className={`py-2.5 px-5 rounded-full border text-[0.85rem] font-semibold no-underline transition-all ${
                  e.slug === entry.slug
                    ? 'border-gold bg-gold-dark text-white'
                    : 'border-border text-ink hover:border-gold hover:text-gold-dark bg-white'
                }`}
              >
                {e.h1.replace(/ — .*$/, '')}
              </Link>
      ...
      <section className="py-6 px-4 sm:px-8">
        <div className="max-w-content mx-auto">
          <WeitereLinkvorschlaege currentPath={`/aufhebungsvertrag/${entry.slug}`} />
        </div>
      </section>
