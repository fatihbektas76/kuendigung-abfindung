...
export const internalLinks: Record<string, Array<{ href: string; label: string }>> = {
  ...
  "/abfindungsrechner": [
    { href: "/abfindung", label: "Ratgeber Abfindung — Höhe, Anspruch & Verhandlung" },
    { href: "/aufhebungsvertrag/aufhebungsvertrag-abfindung", label: "Abfindung im Aufhebungsvertrag verhandeln" },
    { href: "/kuendigung", label: "Kündigung erhalten — Ihre Rechte & nächste Schritte" },
    { href: "/schwellenwert-rechner", label: "Schwellenwert-Rechner: Gilt das KSchG für Sie?" },
  ],
  "/schwellenwert-rechner": [
    { href: "/kuendigung", label: "Kündigung erhalten — Ihre Rechte & nächste Schritte" },
    { href: "/kuendigung-pruefen", label: "Kündigung online prüfen lassen" },
    { href: "/abfindung", label: "Ratgeber Abfindung — Höhe, Anspruch & Verhandlung" },
    { href: "/glossar", label: "Glossar Arbeitsrecht — alle Begriffe erklärt" },
  ],
  "/kuendigungsfrist-rechner": [
    { href: "/kuendigung", label: "Kündigung erhalten — Ihre Rechte & nächste Schritte" },
    { href: "/kuendigung/kuendigung-probezeit", label: "Kündigung in der Probezeit — Fristen & Rechte" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag statt Kündigung — Vor- und Nachteile" },
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung — wann wirksam?" },
  ],
  "/kuendigung-pruefen": [
    { href: "/kuendigung", label: "Kündigung erhalten — alle Rechte im Überblick" },
    { href: "/abfindung", label: "Abfindung nach Kündigung — wie viel steht Ihnen zu?" },
    { href: "/abfindungsrechner", label: "Abfindungsrechner — Abfindung sofort berechnen" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag als Alternative zur Klage" },
    { href: "/kuendigungsfrist-rechner", label: "Kündigungsfrist berechnen" },
  ],
  "/abmahnung-pruefen": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte & Optionen" },
    { href: "/kuendigung", label: "Kündigung nach Abmahnung — wann droht sie?" },
    { href: "/ratgeber/muster/widerspruch-abmahnung", label: "Muster: Widerspruch gegen Abmahnung" },
    { href: "/ratgeber/muster/gegendarstellung-abmahnung", label: "Muster: Gegendarstellung zur Abmahnung" },
  ],
  "/ueberstundenrechner": [
    { href: "/kuendigung", label: "Kündigung erhalten — Überstunden abgelten lassen" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag — Überstunden richtig regeln" },
    { href: "/urlaubsabgeltung-rechner", label: "Urlaubsabgeltung berechnen" },
    { href: "/abfindung", label: "Abfindung — alle Ansprüche bei Beendigung sichern" },
  ],
  "/urlaubsabgeltung-rechner": [
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag — Urlaub richtig regeln" },
  ...
  "/urlaub-teilzeit-rechner": [
    ...
    { href: "/urlaubsabgeltung-rechner", label: "Urlaubsabgeltung berechnen" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag — Urlaubsansprüche sichern" },
  ],
  "/rvg-rechner": [
    { href: "/kuendigung", label: "Kündigung erhalten — was kostet ein Anwalt?" },
    { href: "/abfindung", label: "Abfindung — lohnt sich ein Anwalt?" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag prüfen lassen — Kosten" },
    { href: "/tools", label: "Alle Tools & Rechner im Überblick" },
  ],
  "/fristlose-kuendigung": [
    { href: "/abmahnung", label: "Abmahnung vor Kündigung — wann erforderlich?" },
    { href: "/kuendigung", label: "Ordentliche Kündigung — Unterschiede & Rechte" },
    { href: "/kuendigung-pruefen", label: "Kündigung online prüfen lassen" },
    { href: "/abfindung", label: "Abfindung auch bei fristloser Kündigung?" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag statt fristloser Kündigung" },
  ],
  "/tools": [
    { href: "/abfindungsrechner", label: "Abfindungsrechner — Abfindung sofort berechnen" },
    { href: "/kuendigungsfrist-rechner", label: "Kündigungsfrist-Rechner" },
    { href: "/schwellenwert-rechner", label: "Schwellenwert-Rechner — KSchG-Anwendbarkeit" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen — kostenloser Schnellcheck" },
    { href: "/aufhebungsvertrag-pruefen", label: "Aufhebungsvertrag prüfen — Ampel-Check" },
    { href: "/abmahnung-pruefen", label: "Abmahnung prüfen — ist sie wirksam?" },
  ],
  "/ratgeber/muster": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte" },
    { href: "/aufhebungsvertrag", label: "Ratgeber Aufhebungsvertrag" },
    { href: "/kuendigung", label: "Ratgeber Kündigung — alle Rechte" },
    { href: "/abmahnung-pruefen", label: "Abmahnung online prüfen" },
  ],
  "/urteile/bag-2-azr-140-12-leiharbeitnehmer-schwellenwert": [
    { href: "/schwellenwert-rechner", label: "Schwellenwert-Rechner — KSchG für Ihren Betrieb?" },
    { href: "/kuendigung", label: "Kündigung & Kündigungsschutz — Ihre Rechte" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-2-azr-541-09-emmely-abmahnung-kuendigung": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Rechte & Gegenwehr" },
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung — wann wirksam?" },
    { href: "/kuendigung-pruefen", label: "Kündigung online prüfen" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-6-azr-333-21-aufhebungsvertrag-faires-verhandeln": [
    { href: "/aufhebungsvertrag", label: "Ratgeber Aufhebungsvertrag — Rechte & Risiken" },
    { href: "/aufhebungsvertrag-pruefen", label: "Aufhebungsvertrag prüfen — Ampel-Check" },
    { href: "/aufhebungsvertrag/aufhebungsvertrag-widerruf", label: "Aufhebungsvertrag widerrufen — geht das?" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-2-azr-773-13-social-media-kuendigung": [
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung — Voraussetzungen" },
    { href: "/abmahnung", label: "Abmahnung vor Kündigung — immer nötig?" },
    { href: "/kuendigung-pruefen", label: "Kündigung online prüfen" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-2-azr-17-23-whatsapp-kuendigung-chatgruppe": [
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung — Voraussetzungen" },
    { href: "/kuendigung", label: "Kündigung — alle Rechte im Überblick" },
    { href: "/abmahnung", label: "Abmahnung statt Kündigung — wann?" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-9-azr-541-15-urlaubsverfall-hinweispflicht": [
    { href: "/urlaubsabgeltung-rechner", label: "Urlaubsabgeltung berechnen" },
    { href: "/urlaub-teilzeit-rechner", label: "Urlaub bei Teilzeit berechnen" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag — Urlaub richtig regeln" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-5-azr-716-15-mindestlohn-bereitschaftsdienst": [
    { href: "/ueberstundenrechner", label: "Überstundenrechner — Ansprüche berechnen" },
    { href: "/kuendigung", label: "Kündigung — Ihre Rechte als Arbeitnehmer" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/urteile/bag-1-abr-22-21-arbeitszeiterfassung-pflicht": [
    { href: "/ueberstundenrechner", label: "Überstundenrechner — Ansprüche berechnen" },
    { href: "/kuendigung", label: "Kündigung — Ihre Rechte als Arbeitnehmer" },
    { href: "/ratgeber/urteile", label: "Alle BAG-Urteile im Überblick" },
  ],
  "/ratgeber/muster/widerspruch-abmahnung": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — alle Rechte" },
    { href: "/abmahnung-pruefen", label: "Abmahnung online prüfen — kostenlos" },
    { href: "/ratgeber/muster/gegendarstellung-abmahnung", label: "Muster: Gegendarstellung zur Abmahnung" },
    { href: "/kuendigung", label: "Kündigung nach Abmahnung — was tun?" },
  ],
  "/ratgeber/muster/gegendarstellung-abmahnung": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — alle Rechte" },
    { href: "/abmahnung-pruefen", label: "Abmahnung online prüfen — kostenlos" },
    { href: "/ratgeber/muster/widerspruch-abmahnung", label: "Muster: Widerspruch gegen Abmahnung" },
  ],
  "/ratgeber/muster/checkliste-aufhebungsvertrag": [
    { href: "/aufhebungsvertrag", label: "Ratgeber Aufhebungsvertrag — Rechte & Risiken" },
    { href: "/aufhebungsvertrag-pruefen", label: "Aufhebungsvertrag prüfen — Ampel-Check" },
    { href: "/aufhebungsvertrag/aufhebungsvertrag-abfindung", label: "Abfindung im Aufhebungsvertrag" },
    { href: "/aufhebungsvertrag/aufhebungsvertrag-sperrzeit", label: "Sperrzeit beim Aufhebungsvertrag vermeiden" },
  ],
  "/ratgeber/muster/checkliste-abmahnung": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — alle Rechte" },
    { href: "/abmahnung-pruefen", label: "Abmahnung prüfen — ist sie wirksam?" },
    { href: "/ratgeber/muster/widerspruch-abmahnung", label: "Muster: Widerspruch gegen Abmahnung" },
  ],
  "/ratgeber/muster/kuendigungsschutzklage": [
    { href: "/kuendigung", label: "Kündigung erhalten — Ihre Rechte" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen — Schnellcheck" },
    { href: "/abfindung", label: "Abfindung bei Kündigungsschutzklage" },
    { href: "/kuendigungsfrist-rechner", label: "Kündigungsfrist berechnen" },
  ],
  "/ratgeber/muster/abmahnung-unentschuldigtes-fehlen": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — alle Rechte" },
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung nach Abmahnung" },
    { href: "/abmahnung-pruefen", label: "Abmahnung prüfen — ist sie wirksam?" },
  ],
  "/abmahnung-seiten/einer-abmahnung": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte" },
    { href: "/kuendigung", label: "Kündigung nach einer Abmahnung — was tun?" },
    { href: "/abmahnung-pruefen", label: "Abmahnung prüfen — ist sie wirksam?" },
    { href: "/ratgeber/muster/widerspruch-abmahnung", label: "Muster: Widerspruch gegen Abmahnung" },
  ],
  "/abmahnung-seiten/zwei-abmahnungen": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte" },
    { href: "/kuendigung", label: "Kündigung nach zwei Abmahnungen — Ihre Chancen" },
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung — wann droht sie?" },
    { href: "/abmahnung-pruefen", label: "Abmahnung prüfen — ist sie wirksam?" },
  ],
  "/abmahnung-seiten/drei-abmahnungen": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte" },
    { href: "/kuendigung", label: "Kündigung nach Abmahnungen — Ihre Optionen" },
    { href: "/fristlose-kuendigung", label: "Fristlose Kündigung — Voraussetzungen" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen — kostenloser Check" },
  ],
  "/abmahnung-seiten/vier-abmahnungen": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte" },
    { href: "/kuendigung", label: "Kündigung trotz Abmahnungen angreifbar?" },
    { href: "/abfindung", label: "Abfindung bei Kündigung nach Abmahnung" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen lassen" },
  ],
  "/abmahnung-seiten/fuenf-abmahnungen": [
    { href: "/abmahnung", label: "Ratgeber Abmahnung — Ihre Rechte" },
    { href: "/kuendigung", label: "Kündigung nach Abmahnungen — was nun?" },
    { href: "/abfindung", label: "Abfindung trotz Abmahnungen möglich?" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag als Alternative" },
  ],
  "/ratgeber/kuendigungsstatistik-arbeitsgerichte-deutschland": [
    { href: "/kuendigung", label: "Kündigung erhalten — Ihre Rechte" },
    { href: "/abfindung", label: "Abfindung — Höhe & Verhandlung" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen — kostenloser Check" },
    { href: "/ratgeber/urteile", label: "Aktuelle BAG-Urteile" },
  ],
  "/kuendigung/kuendigung-schwangerschaft": [
    { href: "/kuendigung", label: "Kündigung — alle Rechte im Überblick" },
    { href: "/abfindung", label: "Abfindung bei rechtswidriger Kündigung" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen — kostenloser Check" },
  ],
  "/kuendigung/kuendigung-wegen-krankheit": [
    { href: "/kuendigung", label: "Kündigung — alle Rechte im Überblick" },
    { href: "/abfindung", label: "Abfindung bei krankheitsbedingter Kündigung" },
    { href: "/aufhebungsvertrag", label: "Aufhebungsvertrag statt Kündigung" },
    { href: "/kuendigung-pruefen", label: "Kündigung prüfen — kostenloser Check" },
  ],
  "/kuendigung/kuendigung-minijob": [
    { href: "/kuendigung", label: "Kündigung — alle Rechte im Überblick" },
    { href: "/kuendigungsfrist-rechner", label: "Kündigungsfrist berechnen" },
    { href: "/schwellenwert-rechner", label: "Gilt Kündigungsschutz im Minijob?" },
  ],
  "/aufhebungsvertrag/aufhebungsvertrag-sperrzeit": [
    { href: "/aufhebungsvertrag", label: "Ratgeber Aufhebungsvertrag — Überblick" },
    { href: "/aufhebungsvertrag-pruefen", label: "Aufhebungsvertrag prüfen — Ampel-Check" },
    { href: "/aufhebungsvertrag/aufhebungsvertrag-abfindung", label: "Abfindung im Aufhebungsvertrag" },
    { href: "/kuendigung", label: "Kündigung statt Aufhebungsvertrag — weniger Risiko?" },
  ],
  "/aufhebungsvertrag/aufhebungsvertrag-zeugnis": [
    { href: "/aufhebungsvertrag", label: "Ratgeber Aufhebungsvertrag — Überblick" },
    { href: "/aufhebungsvertrag-pruefen", label: "Aufhebungsvertrag prüfen — Ampel-Check" },
    { href: "/aufhebungsvertrag/aufhebungsvertrag-muster", label: "Aufhebungsvertrag Muster & Checkliste" },
  ],
};
