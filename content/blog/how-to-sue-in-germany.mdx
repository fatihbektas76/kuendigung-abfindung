...
featured: true
image: "/blog/how-to-sue-in-germany.webp"
keywords:
  - sue in Germany
...
**Key difference from US litigation:** In Germany, there is **no discovery process**. You cannot compel the other side to hand over documents before or during trial. Each party must present their own evidence. This makes it essential to gather and preserve all relevant documents *before* filing. For more on these procedural differences, see [how German courts work](/blog/how-german-courts-work).
...
**Need it even faster?** [Interim injunctions](/blog/interim-injunctions-germany) (*einstweilige Verfügungen*) can be obtained within **days to weeks** in urgent cases — for example, to stop a competitor from infringing your IP or to freeze assets.
...
**1. Waiting too long.** German statutes of limitation (*Verjährung*) are strict. The standard limitation period is **3 years** from the end of the year in which the claim arose (§ 195, § 199 BGB). Miss it, and your claim is gone — no exceptions. Read our [complete guide to German limitation periods](/blog/statute-of-limitations-germany) for the full picture.
...
**5. Trying to enforce a US judgment directly.** US court judgments are generally [not enforceable in Germany](/blog/enforcing-us-judgment-in-germany) without a separate proceeding. Plan ahead — if the defendant's assets are in Germany, consider suing in Germany from the start.
