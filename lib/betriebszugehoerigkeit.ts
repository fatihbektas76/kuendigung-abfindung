...
function getFrist(year: number): string {
  if (year < 2) return '4 Wochen zum 15. oder zum Monatsende';
  if (year < 5) return '1 Monat zum Monatsende';
  if (year < 8) return '2 Monate zum Monatsende';
  if (year < 10) return '3 Monate zum Monatsende';
  if (year < 12) return '4 Monate zum Monatsende';
  if (year < 15) return '5 Monate zum Monatsende';
  if (year < 20) return '6 Monate zum Monatsende';
